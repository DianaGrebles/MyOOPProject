...
public class MyHashMap {
    public static void main(String[] args) {
        ...
        dictionarulNostru.replace(3, "Third", "Third-replaced");
        ...
        studenti.put("Ionescu Ion", true);
        studenti.put("Ionescu Gica", false);
        studenti.put("Popescu Gigel", true);
        studenti.put("Popescu Marin", true);
        for (String c : studenti.keySet()) {
            if (studenti.get(c)) {
                //System.out.println(studenti.get(c));
